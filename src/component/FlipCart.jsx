...
const FlipCard = () => {
    return (
        ...
        <CardInner>
            ...
            웹표준과 접근성을 고려한 시맨틱 마크업과 스타일 가이드를 적용한 후 마지막에는 컴포넌트화를 통해 코드의 재사용성과 유지보수 효율성을 높였습니다.
            ...
            I finish by componentizing the code to enhance reusability and maintainability.
            <p className="lang">
