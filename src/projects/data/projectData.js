export const projectData = [
    { 
        ...
        title: "개인자산관리",
        img: process.env.PUBLIC_URL +"/assets/ProjectFinance.jpg",
    ...
    { 
        ...
        img: process.env.PUBLIC_URL +"/assets/LMS.jpg",
    ...
    { 
        ...
        img: process.env.PUBLIC_URL +"/assets/Dubidub.jpg",
    ...
    { 
        ...
        img: process.env.PUBLIC_URL +"/assets/TBN.jpg",
    ...
    { 
        ...
        title: "가상화폐거래소 UI&UX",
        img: process.env.PUBLIC_URL +"/assets/Exchange.jpg",
    ...
    { 
        ...
        img: process.env.PUBLIC_URL +"/assets/KBAS.jpg",
    ...
    {  
        ...
        img: process.env.PUBLIC_URL +"/assets/Snu.jpg",
